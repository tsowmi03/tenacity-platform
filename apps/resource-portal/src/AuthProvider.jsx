...
// Portal admission. Identity is shared with the admin portal through the same
// Firebase project, so the role claim — not the origin — decides who may stay
// signed in here. Anyone else is signed out before any protected UI renders.
export const PORTAL_ALLOWED_ROLES = ["admin", "tutor"];
export const PORTAL_ACCESS_DENIED_MESSAGE =
  "This account cannot access the resource portal. Sign in with a Tenacity tutor or admin account.";
...
export function AuthProvider({ children }) {
  ...
  }, [user, role, isAdmin, isTutor, accessError, loading]);
