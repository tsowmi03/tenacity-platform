    ...
    <ToastProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* Unknown paths — /resources among them, now that the resource
              surface is its own application — render the admin 404 rather
              than silently falling through to the dashboard. Nothing here
              redirects to the resource portal. */}
          <Route
            path="*"
            element={
              <StaffRoute>
