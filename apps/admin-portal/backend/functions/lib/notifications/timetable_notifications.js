...
exports.onAttendanceChangeNotifyAdmins = exports.onPermanentEnrolmentNotifyAdmins = exports.onPermanentSpotOpened = exports.onSessionCancellation = exports.dailyLessonAndShiftReminder = void 0;
...
exports.onSessionCancellation = (0, firestore_2.onDocumentUpdated)("classes/{classId}/attendance/{attendanceId}", async (event) => {
    var _a, _b, _c;
    ...
    try {
        ...
        // Get session date
        const sessionDate = (_c = afterData.date) === null || _c === void 0 ? void 0 : _c.toDate();
        const sessionDateStr = sessionDate
            ? luxon_1.DateTime.fromJSDate(sessionDate).setZone("Australia/Sydney").toFormat("cccc d LLLL")
            : `${classDay}`;
        ...
        if (wasCancelled) {
            ...
            const assignedTutors = afterData.tutors || [];
            ...
            const enrolledStudents = afterData.attendance || [];
            ...
            if (tokens.length > 0) {
                ...
                console.log(`[onSessionCancellation] Sent cancellation notifications: success=${response.successCount}, failure=${response.failureCount}, total=${tokens.length}`);
            ...
            if (tokens.length > 0) {
                ...
                const response = await messaging.sendEachForMulticast(message);
                console.log(`[onSessionCancellation] Sent reactivation notifications: success=${response.successCount}, failure=${response.failureCount}, total=${tokens.length}`);
                if (response.failureCount > 0) {
...
exports.onPermanentSpotOpened = (0, firestore_2.onDocumentUpdated)("classes/{classId}", async (event) => {
    var _a, _b;
...
exports.onPermanentEnrolmentNotifyAdmins = (0, firestore_2.onDocumentUpdated)("classes/{classId}", async (event) => {
    var _a, _b, _c, _d;
    if (!((_a = event.data) === null || _a === void 0 ? void 0 : _a.before) || !((_b = event.data) === null || _b === void 0 ? void 0 : _b.after))
        return;
    const beforeArr = event.data.before.data().enrolledStudents || [];
...
exports.onAttendanceChangeNotifyAdmins = (0, firestore_2.onDocumentUpdated)("classes/{classId}/attendance/{attendanceId}", async (event) => {
...
//# sourceMappingURL=timetable_notifications.js.map