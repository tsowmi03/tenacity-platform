...
| --- | ---: | ---: | ---: | ---: |
| Reference screens | 10 / 16 | 6 | 0 | 0 |
| Design foundation workstreams | 5 / 8 | 2 | 1 | 0 |
| Supporting/detail workstreams | 7 / 10 | 3 | 0 | 0 |
...
legacy screens behind them were deleted on 29 Jul 2026.
...
Phase 4 remains active only because the finished admin screens still need
product-owner visual acceptance inside `HomeScreen`. This is acceptance work,
not a remaining legacy seam.
...
3. Visually accept S05, S08, and S09. S09 also needs a live PDF smoke test.
   A01 still needs the direct New enrol picker; its class-side enrolment route
   is complete.
4. Confirm A05 against the admin reference on device. It is expected to need no
   code change.
