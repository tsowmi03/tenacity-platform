...
function validatePracticePaperResource(resource, options = {}) {
  ...
  optionalStimulus(resource.stimulus, "practicePaper.stimulus");
...
async function buildPracticePaperDocx(resource, options = {}) {
  ...
  // English papers carry a reading stimulus booklet (block-aware, one shaded box
  // per text) rendered before the question sections.
