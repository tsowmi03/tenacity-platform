...
const FIXTURES = [
  ...
  ["annotation-task", {
    ...
    tasks: [
      { number: 1, instruction: "Identify one example of symbolism and explain its effect.", type: "analyse", marks: 3, focusQuote: "the town still set its clocks by it" },
      { number: 2, instruction: "How does the writer use the lighthouse to reflect the woman's grief?", type: "analyse", marks: 4, focusQuote: null },
      { number: 3, instruction: "Comment on the effect of the phrase 'two landmarks the tide could not move'.", type: "evaluate", marks: 3, focusQuote: "two landmarks the tide could not move" },
    ],
    markingGuide: [
  ...
  ["essay-scaffold", {
    ...
    subject: "english",
    year: 9,
    topics: ["Persuasive writing", "Essay structure"],
  ...
  ["practice-paper", {
    ...
    subject: "english",
    year: 9,
    topics: ["Persuasive techniques", "Rhetoric"],
